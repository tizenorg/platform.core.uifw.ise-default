...
#ifdef KEY_PROPERTIES_PHASE
{
	...
	},
	{
		...
		_Label_ {{""},{""},{""}},
		LABEL_PROPERTIES_QTY_DEFAULT_TYPE,
		_LabelImg_ {{"textinput_french_icon_clear.png","textinput_french_icon_clear.png"}, {"textinput_french_icon_clear.png","textinput_french_icon_clear.png"}, {"textinput_french_icon_clear.png","textinput_french_icon_clear.png"}},
