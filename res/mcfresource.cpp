...
mcfboolean mcf_sublayout_support_table[MAX_INPUT_MODE][SUBLAYOUTID_MAX] = {
    ...
    {	TRUE,				FALSE,					FALSE,				FALSE,	  }, //INPUT_MODE_QTY_URL,
    {	TRUE,				FALSE,					FALSE,				FALSE,	  }, //INPUT_MODE_QTY_EMAIL,
    {	TRUE,				FALSE,					FALSE,				FALSE,	  }, //INPUT_MODE_QTY_SYM_1,
    {	TRUE,				FALSE,					FALSE,				FALSE,	  }, //INPUT_MODE_QTY_SYM_2,
    {	TRUE,				FALSE,					FALSE,				FALSE,	  }, //INPUT_MODE_QTY_SYM_3,
    {	TRUE,				FALSE,					FALSE,				FALSE,	  }, //INPUT_MODE_QTY_SYM_4,

    {	TRUE,				FALSE,					FALSE,				FALSE,	  }, //INPUT_MODE_QTY_FRENCH,
    {	TRUE,				FALSE,					FALSE,				FALSE,	  }, //INPUT_MODE_QTY_SPANISH,
    {	TRUE,				FALSE,					FALSE,				FALSE,	  }, //INPUT_MODE_QTY_ITALIAN,
    {	TRUE,				FALSE,					FALSE,				FALSE,	  }, //INPUT_MODE_QTY_DUTCH,
    {	TRUE,				FALSE,					FALSE,				FALSE,	  }, //INPUT_MODE_QTY_PORTUGUESE,
    {	TRUE,				FALSE,					FALSE,				FALSE,	  }, //INPUT_MODE_QTY_GERMAN,

    {	TRUE,				FALSE,					FALSE,				FALSE,	  }, //INPUT_MODE_QTY_TURKISH,
    {	TRUE,				FALSE,					FALSE,				FALSE,	  }, //INPUT_MODE_QTY_GREEK,
    {	TRUE,				FALSE,					FALSE,				FALSE,	  }, //INPUT_MODE_QTY_RUSSIAN,
};
