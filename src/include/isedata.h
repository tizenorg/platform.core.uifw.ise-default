...
static const ISEDefaultValueTable IseDefaultValue[MAX_ISE_LAYOUT_CNT]  = {
	{ISE_LAYOUT_STYLE_NORMAL,			INPUT_MODE_NATIVE,			KEYPAD_QWERTY,	INPUTMODE_AMBIGUOUS, 	SHIFTMODE_OFF,	OFF,	COMPLETION_MULTITAB_LOWERCASE_STRING, SINGLE_COMMIT_OFF,FALSE},
	{ISE_LAYOUT_STYLE_NUMBER,			INPUT_MODE_QTY_SYM_1,			KEYPAD_QWERTY,  INPUTMODE_AMBIGUOUS,    SHIFTMODE_OFF,	OFF,	COMPLETION_NUMERIC_STRING,SINGLE_COMMIT_OFF, FALSE},
	{ISE_LAYOUT_STYLE_EMAIL,			INPUT_MODE_QTY_EMAIL,			KEYPAD_QWERTY,	INPUTMODE_AMBIGUOUS ,	SHIFTMODE_OFF,	OFF,	COMPLETION_QWERTY_STRING, SINGLE_COMMIT_ON,TRUE},
	{ISE_LAYOUT_STYLE_URL,				INPUT_MODE_QTY_URL,			KEYPAD_QWERTY,	INPUTMODE_AMBIGUOUS, 	SHIFTMODE_OFF,	OFF,	COMPLETION_QWERTY_STRING,SINGLE_COMMIT_ON, TRUE},
	{ISE_LAYOUT_STYLE_PHONENUMBER,			INPUT_MODE_QTY_SYM_1,		    	KEYPAD_QWERTY,  INPUTMODE_AMBIGUOUS,	SHIFTMODE_OFF,	OFF,	COMPLETION_NUMERIC_STRING, SINGLE_COMMIT_OFF,FALSE},
	{ISE_LAYOUT_STYLE_IP,				INPUT_MODE_QTY_SYM_1,		    	KEYPAD_QWERTY,  INPUTMODE_AMBIGUOUS,	SHIFTMODE_OFF,	OFF,	COMPLETION_NUMERIC_STRING,SINGLE_COMMIT_OFF, FALSE},
	{ISE_LAYOUT_STYLE_MONTH,			INPUT_MODE_QTY_SYM_1,			KEYPAD_QWERTY,  INPUTMODE_AMBIGUOUS,	SHIFTMODE_OFF,	OFF,	COMPLETION_NUMERIC_STRING,SINGLE_COMMIT_OFF, FALSE},
	{ISE_LAYOUT_STYLE_NUMBERONLY,			INPUT_MODE_QTY_SYM_1,		   	KEYPAD_QWERTY,  INPUTMODE_AMBIGUOUS,	SHIFTMODE_OFF,	OFF,	COMPLETION_NUMERIC_STRING,SINGLE_COMMIT_OFF, FALSE},
};
